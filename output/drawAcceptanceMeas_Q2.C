...
/////////////////////////////////////////////////////////////
void drawAcceptanceMeas_Q2(TString infile = "data/diffractiveDiJets_ep_18x275GeV_ee_genkT_full.root", TString mkdir = "Acceptance", TString outfile = "Acceptance_meas_Q2.root") {
	...
	names->push_back("h_Event_JetMeas_nHCal_2_Q2");
	names->push_back("h_Event_JetMeas_nHCal_1_Q2");
	names->push_back("h_Event_JetMeas_nHCal_0_Q2");
	names->push_back("h_Event_JetMeas_AllHCal_Q2");
...
*/
	...
	vec_cnv->at(0)->cd(1)->SaveAs("Acceptance_meas_Q2.png");
	vec_cnv->at(0)->cd(2)->SaveAs("Acceptance_meas_Q2_log.png");
