...
/////////////////////////////////////////////////////////////
void drawAcceptanceMeas_Q2(TString infile = "data/diffractiveDiJets_ep_18x275GeV_anti_kT_full.root", TString mkdir = "Acceptance", TString outfile = "Acceptance_meas_Q2.root") {
