...
/////////////////////////////////////////////////////////////
void drawAcceptanceMatrix(TString infile = "data/diffractiveDiJets_ep_18x275GeV_anti_kT_full.root", TString mkdir = "Acceptance", TString outfile = "AcceptanceMatrix.root") {
	...
	TH1D *histEvents = (TH1D *)file->Get("h_Events");
