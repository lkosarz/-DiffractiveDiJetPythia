...
/////////////////////////////////////////////////////////////
void drawAcceptanceMeas_x(TString infile = "data/diffractiveDiJets_ep_18x275GeV_ee_genkT_full.root", TString mkdir = "Acceptance", TString outfile = "Acceptance_meas_x.root") {
	...
	names->push_back("h_Event_JetMeas_nHCal_2_x");
	names->push_back("h_Event_JetMeas_nHCal_1_x");
	names->push_back("h_Event_JetMeas_nHCal_0_x");
	names->push_back("h_Event_JetMeas_AllHCal_x");

	names_den->push_back("h_Event_x");
	names_den->push_back("h_Event_x");
	names_den->push_back("h_Event_x");
	names_den->push_back("h_Event_x");
...
/*
	...
	rebin->push_back(4);
*/
	range_hi->push_back(1.0);
	range_lo->push_back(10e-7);
	...
	for (int i = 0; i < names->size(); ++i) {
		...
		hist->GetYaxis()->SetRangeUser(0.00001, 1.5);
	...
	vec_cnv->at(0)->cd(1)->SaveAs("Acceptance_meas_x.png");
	vec_cnv->at(0)->cd(2)->SaveAs("Acceptance_meas_x_log.png");
