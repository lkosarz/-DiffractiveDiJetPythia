...
/////////////////////////////////////////////////////////////
void drawAcceptance_x(TString infile = "data/diffractiveDiJets_ep_18x275GeV_ee_genkT_full.root", TString mkdir = "Acceptance", TString outfile = "Acceptance_x.root") {
	...
	names->push_back("h_Event_nHCal_2_x");
	names->push_back("h_Event_nHCal_1_x");
	names->push_back("h_Event_nHCal_0_x");
	names->push_back("h_Event_AllHCal_x");
...
*/
	...
	vec_cnv->at(0)->cd(1)->SaveAs("Acceptance_x.png");
	vec_cnv->at(0)->cd(2)->SaveAs("Acceptance_x_log.png");
