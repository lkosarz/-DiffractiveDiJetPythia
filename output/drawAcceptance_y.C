...
/////////////////////////////////////////////////////////////
void drawAcceptance_y(TString infile = "data/diffractiveDiJets_ep_18x275GeV_ee_genkT_full.root", TString mkdir = "Acceptance", TString outfile = "Acceptance_y.root") {
	...
	names->push_back("h_Event_nHCal_2_y");
	names->push_back("h_Event_nHCal_1_y");
	names->push_back("h_Event_nHCal_0_y");
	names->push_back("h_Event_AllHCal_y");
...
*/
	...
	vec_cnv->at(0)->cd(1)->SaveAs("Acceptance_y.png");
	vec_cnv->at(0)->cd(2)->SaveAs("Acceptance_y_log.png");
