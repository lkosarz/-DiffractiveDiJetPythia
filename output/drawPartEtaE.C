...
void drawPartEtaEbin(TString infile = "data/diffractiveDiJets_ep_18x275GeV_full.root", double etalo = -4.14, double etahi = -1.18, int charge = -1.0, TString mkdir = "outputSpectra/eta", TString outfile = "outputMomNeg.root", TString pngfile = "h_MCpart_neg_p_eta");

void drawPartEtaE()
{

	TString file = "data/diffractiveDiJets_ep_18x275GeV_full.root";
	TString dir = "outputSpectra/etaEne";

	//file = "data/diffractiveDiJets_ep_18x275GeV_full.root";
	//dir = "outputSpectra/eta";

	drawPartEtaEbin(file, -4.14, -1.18, -1.0, dir, "outputEneNeg_eta_-4.14_-1.18.root", "h_Particle_neg_E_eta");
	drawPartEtaEbin(file, -4.14, -1.18, 1.0, dir, "outputEnePos_eta_-4.14_-1.18.root", "h_Particle_pos_E_eta");

	drawPartEtaEbin(file, -2.0, -1.0, -1.0, dir, "outputEneNeg_eta_-2.0_-1.0.root", "h_Particle_neg_E_eta");
	drawPartEtaEbin(file, -2.0, -1.0, 1.0, dir, "outputEnePos_eta_-2.0_-1.0.root", "h_Particle_pos_E_eta");

	drawPartEtaEbin(file, -3.0, -2.0, -1.0, dir, "outputEneNeg_eta_-3.0_-2.0.root", "h_Particle_neg_E_eta");
	drawPartEtaEbin(file, -3.0, -2.0, 1.0, dir, "outputEnePos_eta_-3.0_-2.0.root", "h_Particle_pos_E_eta");

	drawPartEtaEbin(file, -4.0, -3.0, -1.0, dir, "outputEneNeg_eta_-4.0_-3.0.root", "h_Particle_neg_E_eta");
	drawPartEtaEbin(file, -4.0, -3.0, 1.0, dir, "outputEnePos_eta_-4.0_-3.0.root", "h_Particle_pos_E_eta");

}

/////////////////////////////////////////////////////////////
void drawPartEtaEbin(TString infile, double etalo, double etahi, int charge, TString mkdir, TString outfile, TString pngfile) {
	...
	if(charge>0)
	{
		names->push_back("h_Particle_Pion_p_eta_E");
		names->push_back("h_Particle_Kaon_p_eta_E");
		names->push_back("h_Particle_Proton_p_eta_E");
		names->push_back("h_Particle_Electron_p_eta_E");
		//names->push_back("h_Particle_eta_Electron_p_eta_E");
	}
	if(charge<0)
	{
		names->push_back("h_Particle_Pion_n_eta_E");
		names->push_back("h_Particle_Kaon_n_eta_E");
		names->push_back("h_Particle_Proton_n_eta_E");
		names->push_back("h_Particle_Electron_n_eta_E");
		//names->push_back("h_Particle_eta_Electron_n_eta_E");
	}

	names->push_back("h_Particle_Neutron_eta_E");
	names->push_back("h_Particle_Gamma_eta_E");
